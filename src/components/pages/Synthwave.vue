<template>
  <div class="main monaco-editor">
    <br />
    <p class="mtk3">testing some text</p>
    <p class="mtk4">testing some text</p>
    <p class="mtk5">testing some text</p>
    <p class="mtk6">testing some text</p>
    <p class="mtk7">testing some text</p>
    <p class="mtk8">testing some text</p>
    <p class="mtk9">testing some text</p>

    <div class="partial part" />
  </div>
</template>
